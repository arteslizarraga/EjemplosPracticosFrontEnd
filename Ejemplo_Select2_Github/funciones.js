    ...
    */
    ...
    $(datos.querySelector).select2({
        ...
        ajax: {
            ...
            {
                let query = {
                    q: (p.term != null && p.term != "") ? p.term : "lizarraga",  // Esto es solo para poder usar https://api.github.com/search/repositories
                    search: p.term,
            ...
            {
                //=============================================================>>>>>
                // Forma provisoria para usar https://api.github.com/search/repositories

                return {
                    results: $.map(res.items, function(item, index) {
                        return {
                            "id": item.id,
                            "text": item.name
                        };
